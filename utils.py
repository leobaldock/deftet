...
def get_tetra_centroid(tetra):
    """
    Compute the centroid of a tetrahedron.
    """
    # Expects a tensor of shape [4, 3], with coordinates in X, Y, Z order.
    return torch.sum(tetra, 0) / 4


# TODO try and find a pytorch way of doing these checks.
